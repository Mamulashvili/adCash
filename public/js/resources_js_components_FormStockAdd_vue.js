"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_FormStockAdd_vue"],{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    submitForm: function submitForm(e) {
      ...
      //   this.lname.length === 0)
      // )
      //   return (this.hasFormError = true);

      console.log(this.stockName, this.accentCcolor, this.bgColor, this.image);
    }
  }
});
...
var _hoisted_2 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" Add new stock ");
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  , ["modelValue"]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_base_button, {
    onHandleClick: _cache[4] || (_cache[4] = function (e) {
